        ...
        for i in $tamanos; do
            ...
            for k in $(seq $repeticiones); do
                $(dirname $0)/../build/tp2 diff -i $imp -o $(dirname $0)/exp4/out/diff-$imp $(dirname $0)/exp4/in/phoebe1-$i.bmp $(dirname $0)/exp4/in/phoebe2-$i.bmp |
                    ...
                    nombre=$((dirname $0)/../build/tp2 diff -i $imp -n $(dirname $0)/exp4/in/phoebe1-$i.bmp $(dirname $0)/exp4/in/phoebe2-$i.bmp))
                    rm $(dirname $0)/exp4/out/diff-$imp/$nombre
            done
        ...
        for i in $tamanos; do
            ...
            for k in $(seq $repeticiones); do
                $(dirname $0)/../build/tp2 blur -i $imp -o $(dirname $0)/exp4/out/blur-$imp $(dirname $0)/exp4/in/phoebe1-$i.bmp 5 15 |
                    ...
                    nombre=$((dirname $0)/../build/tp2 blur -i $imp -n $(dirname $0)/exp4/in/phoebe1-$i.bmp))
                    rm $(dirname $0)/exp4/out/blur-$imp/$nombre
            done
